...
The four interface classes currently existing are :ref:`Communicator <Communicator>`, which is intended for bare request-response communication, and three that represent values that can be interacted with: :ref:`Readable`, :ref:`Writable <Writable>` and :ref:`Drivable <Drivable>`.
