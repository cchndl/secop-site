...
The specification is intended to grow and adopt to new needs. (related issue :issue:`038 Extension mechanisms`)
...
.. note::
    Also check :issue:`036 Dynamic units` *as it may have implications for a certain implementation.*
